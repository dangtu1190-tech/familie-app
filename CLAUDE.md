...
│   ├── llm.js      – OCR + Übersetzung via Langdock (OpenAI-kompatibel, GPT-4.1)
...
- Deutsche Straßennamen, Städte, Zahlen, Behördennamen **nicht übersetzen**
- ALLES übersetzen: auch Absender, Empfänger, Betreff, Grußformel

### TTS (ElevenLabs)
- Modell: `eleven_multilingual_v2`
- `language_code: 'vi'` muss immer gesetzt sein
...
| ElevenLabs spricht kein Vietnamesisch | `language_code: 'vi'` in tts.js prüfen |
